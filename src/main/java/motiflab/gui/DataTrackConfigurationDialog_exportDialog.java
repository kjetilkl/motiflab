...
public class DataTrackConfigurationDialog_exportDialog extends javax.swing.JDialog {
    ...
    private CheckBoxNode setupTreeModel(DataConfiguration configuration) {
        ...
        for (String trackName:trackNames) {
            ...
            for (DataSource source:track.getDatasources()) {
                ...
                String organism=motiflab.engine.data.Organism.getCommonName(source.getOrganism());
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(motiflab.gui.MotifLabApp.class).getContext().getResourceMap(DataTrackConfigurationDialog_exportDialog.class);
