...
public class ModuleBrowserPanel extends JPanel implements DataListener {
    ...
    private void updateCountLabelText() {
        ...
        if (modulecollection!=null) numberOfModulesShowingLabel.setText("<html>Matching: "+manualSelectionTable.getRowCount()+" of "+total+"<br>Included: "+countSelectedModules()+" of "+total+"</html>");
