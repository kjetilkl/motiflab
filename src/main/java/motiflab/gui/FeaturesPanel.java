...
public class FeaturesPanel extends DataPanel {
    ...
    private Class filter=motiflab.engine.data.FeatureDataset.class; // 
  ...
  private void initComponents() {
        ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(motiflab.gui.MotifLabApp.class).getContext().getResourceMap(FeaturesPanel.class);
