...
public class DataObjectsPanel extends DataPanel {
  ...
  private void initComponents() {
        ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(motiflab.gui.MotifLabApp.class).getContext().getResourceMap(DataObjectsPanel.class);
