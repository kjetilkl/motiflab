...
public class InteractionsFilterDialog extends javax.swing.JDialog implements RegionVisualizationFilter, MouseListener, DataListener {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(motiflab.gui.MotifLabApp.class).getContext().getResourceMap(InteractionsFilterDialog.class);
