...
import motiflab.gui.prompt.Prompt_Module;
import motiflab.gui.prompt.Prompt_ModuleCollection;
import motiflab.gui.prompt.Prompt_ModulePartition;
import motiflab.gui.prompt.Prompt_Motif;
import motiflab.gui.prompt.Prompt_MotifCollection;
import motiflab.gui.prompt.Prompt_MotifPartition;
...
public class MotifsPanel extends DataPanel {
  ...
  private void initComponents() {
        ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(motiflab.gui.MotifLabApp.class).getContext().getResourceMap(MotifsPanel.class);
