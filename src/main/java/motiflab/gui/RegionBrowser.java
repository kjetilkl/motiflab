...
public class RegionBrowser extends javax.swing.JDialog implements WindowListener, ListSelectionListener, RowSorterListener, RedrawListener {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(motiflab.gui.MotifLabApp.class).getContext().getResourceMap(RegionBrowser.class);
