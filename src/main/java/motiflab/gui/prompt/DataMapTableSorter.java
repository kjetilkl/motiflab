 ...
 *   table.setRowSorter(new DataMapTableSorter(myModel));
 * </pre>
 ...
 * <p>
 * <code>DataMapTableSorter</code> uses <code>Comparator</code>s for doing
 ...
 * </ol>
 * <p>
 * In addition to sorting <code>DataMapTableSorter</code> provides the ability
 ...
 * <pre>
 *   TableModel myModel = createMyTableModel();
 *   DataMapTableSorter sorter = new DataMapTableSorter(myModel);
 ...
 * sortable by default.
 * <p>
 * <code>DataMapTableSorter</code> has one formal type parameter: the type
 ...
 * @since 1.6
 */
public class DataMapTableSorter<M extends TableModel> extends MyDefaultRowSorter<M, Integer> {
    /**
    ...
    /**
     * Creates a <code>DataMapTableSorter</code> with an empty model.
     */
    public DataMapTableSorter() {
        this(null);
    }

    /**
     * Creates a <code>DataMapTableSorter</code> using <code>model</code>
     ...
     */
    public DataMapTableSorter(M model) {
        setModel(model);
    }

    /**
     * Sets the <code>TableModel</code> to use as the underlying model
     * for this <code>DataMapTableSorter</code>.  A value of <code>null</code>
    ...
    public void setModel(M model) {
        tableModel = model;
        setModelWrapper(new DataMapTableSorterModelWrapper());
    }
    ...
    /**
     * Implementation of MyDefaultRowSorter.ModelWrapper that delegates to a
     * TableModel.
     */
    private class DataMapTableSorterModelWrapper extends ModelWrapper<M,Integer> {
        public M getModel() {
            return tableModel;
        }
