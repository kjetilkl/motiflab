 ...
 * <p>
 * In addition to sorting, <code>MyDefaultRowSorter</code> provides the
 ...
 * <p>
 * <code>MyDefaultRowSorter</code> is an abstract class.  Concrete
 ...
 * MyDefaultRowSorter} without specifying a {@code ModelWrapper}.
 * <p>
 * <code>MyDefaultRowSorter</code> has two formal type parameters.  The
...
public abstract class MyDefaultRowSorter<M , I> extends RowSorter<M> {
    ...
    /**
     * Creates an empty <code>MyDefaultRowSorter</code>.
     */
     ...
     * {@code List} do not effect this {@code MyDefaultRowSorter}.
    ...
    private int compare(int model1, int model2) {
        ...
        for (int counter = 0; counter < cachedSortKeys.length; counter++) {
            ...
            if (sortOrder == SortOrder.UNSORTED) {
                ...
                // Treat nulls as < then non-null, but not if the MapValueComparator is used
                Comparator comparator=sortComparators[counter];
                if (comparator instanceof MapValueComparator) {
    ...
    private void checkColumn(int column) {
        if (column < 0 || column >= getModelWrapper().getColumnCount()) {
            throw new IndexOutOfBoundsException(
                    "column ("+column+") beyond range of TableModel: "+getModelWrapper().getColumnCount());
        }
    }


    /**
     * <code>MyDefaultRowSorter.ModelWrapper</code> is responsible for providing
     * the data that gets sorted by <code>MyDefaultRowSorter</code>.  You
     * normally do not interact directly with <code>ModelWrapper</code>.
     * Subclasses of <code>MyDefaultRowSorter</code> provide an
