...
public class Prompt_ModuleNumericMap extends Prompt {
    ...
    private void setupFromPropertyPanel() {
        ...
        fromPropertyCombobox=new JComboBox(Module.getNumericProperties(engine));
    ...
    public boolean onOKPressed() {
        if (tabbedPanel.getSelectedComponent()==importPanel) {
            ...
            try {
                ...
                } else { // the prompt is shown in response to an "Add New Module Numeric Map" request. Just set the basic parameters needed for a command line. A "new" operation task will be run later to create the finished data object and this avoids creating the map twice
