    ...
    */
    ...
    public void setProperty(String property, Object value) {
        if (property.equalsIgnoreCase("start")) {
            ...
            if (value==null || value.toString().isEmpty()) properties.remove(property); // previously "property.toLowerCase()"
            else {
                if (value instanceof ArrayList) value=MotifLabEngine.splice((ArrayList)value, ",");
                properties.put(property, value); // previously "property.toLowerCase()"
            }
        }
    }
