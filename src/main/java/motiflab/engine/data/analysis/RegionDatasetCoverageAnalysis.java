...
public final class RegionDatasetCoverageAnalysis extends Analysis {
    ...
    public Parameter[] getOutputParameters() {
        return new Parameter[] {
             new Parameter("Sort by",String.class,"Sequence name",new String[]{"Sequence name","Coverage ascending","Coverage descending"},"The property to sort sequences by",false,false),
             ...
             new Parameter("Show only groups summary",Boolean.class,Boolean.FALSE,new Boolean[]{Boolean.FALSE,Boolean.TRUE},"Show only the summary statistics for each group and not coverage for individual sequences",false,false),
    ...
    public String[] getOutputParameterFilter(String parameter) {
        ...
        if (parameter.equals("Group by clusters") || parameter.equals("Sort by") || parameter.equals("Show only groups summary")) return new String[]{"HTML","RawData"};        
        return null;
    }     
