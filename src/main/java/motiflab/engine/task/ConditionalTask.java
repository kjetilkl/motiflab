...
import motiflab.engine.protocol.OperationParser;
...
//              }        
        ...
        if (protocol==null || tasklist==null || tasklist.isEmpty()) return null;
            ...
            for (int i=0;i<tasklist.size();i++) {
                ...
                if (condition!=null) {
                    ...
                    if (protocol instanceof motiflab.engine.protocol.StandardProtocol)
    ...
    private String getConditionString(Protocol protocol, Condition_basic condition) {
        ...
        if (!(parser instanceof motiflab.engine.protocol.StandardOperationParser)) return "<ERROR: Unable to format condition>";
        return ((motiflab.engine.protocol.StandardOperationParser)parser).getCommandString_condition(condition);        
    }
