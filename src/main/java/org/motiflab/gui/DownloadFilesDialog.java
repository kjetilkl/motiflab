...
public class DownloadFilesDialog extends javax.swing.JDialog {
                ...
                for (Object[] file:files) {
                   ...
                   try {
                      ...
                      if (listener!=null) listener.propertyChange(new PropertyChangeEvent(currentURL, "newfile", null, thisfilesize));
                        org.motiflab.engine.util.FileUtilities.copyLargeURLToFile(url, destination, listener, abortFlag);
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(org.motiflab.gui.MotifLabApp.class).getContext().getResourceMap(DownloadFilesDialog.class);
