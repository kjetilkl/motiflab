 ...
 * @author  kjetikl
 */
public class ModuleBrowser extends javax.swing.JDialog implements ListSelectionListener, RowSorterListener, WindowListener, RedrawListener {
    private static String VISUALIZE_ALL="";
    private static String VISUALIZE_SHOWN="only matching modules";
    private static String VISUALIZE_SELECTED="only selected modules";

    private ModuleBrowserPanel modulebrowser;
    ...
    public ModuleBrowser(MotifLabGUI gui) {
        super(gui.getFrame(), false);
        this.gui=gui;
        initComponents();
        Border emptyBorder=BorderFactory.createEmptyBorder(10,6,0,6);
        modulebrowser=new ModuleBrowserPanel(gui,null,false,true);
        gui.getEngine().addDataListener(modulebrowser);
        Dimension size=new Dimension(580,500);
        modulebrowser.setPreferredSize(size);
        modulebrowser.setBorder(BorderFactory.createCompoundBorder(emptyBorder, BorderFactory.createRaisedBevelBorder()));
        this.add(modulebrowser);
        pack();
        getRootPane().setDefaultButton(closeButton);
        table=modulebrowser.getTable();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(org.motiflab.gui.MotifLabApp.class).getContext().getResourceMap(ModuleBrowser.class);
...
private void visualizefilterchanged(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_visualizefilterchanged
    ...
    public void windowClosed(WindowEvent e) {
        gui.getEngine().removeDataListener(modulebrowser);
    }
