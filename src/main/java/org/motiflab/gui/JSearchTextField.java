...
public class JSearchTextField extends JTextField implements FocusListener, MouseListener {
    ...
    public JSearchTextField(){
        ...
        java.net.URL grayIconURL=getClass().getResource("/org/motiflab/gui/resources/icons/searchTextfieldIcon16.png");
        if (grayIconURL!=null) grayIcon=new ImageIcon(grayIconURL);  
        java.net.URL colorIconURL=getClass().getResource("/org/motiflab/gui/resources/icons/searchTextfieldIconColor16.png");
