 ...
 * MotifBrowser.java
 *
 * Created on 12. april 2010, 15:22
 */
 ...
 * @author  kjetikl
 */
public class MotifBrowser extends javax.swing.JDialog implements ListSelectionListener, RowSorterListener, WindowListener, RedrawListener {
    private static String VISUALIZE_ALL="";
    private static String VISUALIZE_SHOWN="only matching motifs";
    private static String VISUALIZE_SELECTED="only selected motifs";

    //private MotifBrowserPanel motifbrowser;
    private MotifBrowserPanel motifbrowser;
    ...
    public MotifBrowser(MotifLabGUI gui) {
        super(gui.getFrame(), false);
        this.gui=gui;
        initComponents();
        Border emptyBorder=BorderFactory.createEmptyBorder(10,6,0,6);
        //motifbrowser=new MotifBrowserPanel(gui,null,false,true);
        motifbrowser=new MotifBrowserPanel(gui,null,false,true);
        gui.getEngine().addDataListener(motifbrowser);
        Dimension size=new Dimension(580,500);
        motifbrowser.setPreferredSize(size);
        motifbrowser.setBorder(BorderFactory.createCompoundBorder(emptyBorder, BorderFactory.createRaisedBevelBorder()));
        this.add(motifbrowser);
        pack();
        getRootPane().setDefaultButton(closeButton);
        table=motifbrowser.getTable();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(org.motiflab.gui.MotifLabApp.class).getContext().getResourceMap(MotifBrowser.class);
...
private void visualizefilterchanged(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_visualizefilterchanged
    ...
    private void updateVisualization() {
         ...
         if (selection.equals(VISUALIZE_SHOWN)) {
             motifbrowser.setVisibilityOnAllMotifs(false);
    ...
    public void windowClosed(WindowEvent e) {
        gui.getEngine().removeDataListener(motifbrowser);
    }
