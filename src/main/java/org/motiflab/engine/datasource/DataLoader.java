...
import org.motiflab.engine.Cache;
...
public class DataLoader {
    ...
    private void revertSettings() {
        ...
        try {
            inputStream=new BufferedReader(new InputStreamReader(this.getClass().getResourceAsStream("/org/motiflab/engine/datasource/DataTracks.xml")));
