...
import org.motiflab.engine.dataformat.DataFormat_INCLUSive_Background;
import org.motiflab.engine.dataformat.DataFormat_Location;
    ...
    public static void main(String[] args) {     
        ...
        for (int i=0;i<args.length;i++) {
            if (!args[i].startsWith("-")) reportErrorShowUsageAndAbort("Options must start with '-'");    
                ...
                System.setProperty("java.util.prefs.PreferencesFactory", org.motiflab.engine.util.FilePreferencesFactory.class.getName());               
            }
