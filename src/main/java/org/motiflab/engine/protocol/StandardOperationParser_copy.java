 ...
 * @author kjetikl
 */
public class StandardOperationParser_copy extends StandardOperationParser {
    ...
    public String getCommandString(OperationTask task) {
        ...
        String msg=targetName+" = copy "+sourceName;   
        return msg;
    }
    ...
    public OperationTask parse(String command) throws ParseError {
           ...
           String operationName="copy";
           String sourceName=null;
           String targetName=null;           
          
           Pattern pattern=Pattern.compile("^(([a-zA-Z_0-9-]+)\\s*=\\s*)?copy ([a-zA-Z_0-9-]+)?(\\s*\\S.*)?");  
